...
import { ExternalLink, AlertCircle, RefreshCw, BookOpen } from "lucide-react"
import { AppHelpModal, HelpButton } from "@/components/shared/app-help-modal"

const JEDI_URL = "https://strms-jedi.vercel.app/"
...
export default function JediPage() {
  ...
  const openInNewTab = () => {
    window.open(JEDI_URL, "_blank", "noopener,noreferrer")
  }
  ...
  const retryIframe = () => {
    ...
    if (iframeRef.current) {
      iframeRef.current.src = JEDI_URL
    }
  }
    ...
    <div className="flex flex-col h-screen bg-[#FAF9F9]">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-white">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-[#407B9D]/10 flex items-center justify-center">
            <BookOpen className="w-5 h-5 text-[#407B9D]" />
          </div>
          <div>
            <h1
            ...
            >
              Journal Entry Digital Intelligence
            </p>
          </div>
        </div>
      ...
      <div className="flex-1 relative">
            ...
            <Card className="max-w-md mx-4 bg-white border-none shadow-lg">
              <CardHeader className="text-center pb-2">
                ...
                <CardTitle
                  ...
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  Unable to Embed JEDI
                </CardTitle>
                <CardDescription
                  className="text-sm"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  JEDI may have security settings that prevent embedding. You can still access it in a new tab.
                </CardDescription>
              </CardHeader>
        ...
        <iframe
          ...
          title="JEDI - Journal Entry Digital Intelligence"
      ...
      <AppHelpModal
        appName="JEDI"
        appDescription="Journal Entry Digital Intelligence - Upload bank statements, extract journal entries with AI, and push directly to QuickBooks Online."
        isOpen={showHelp}
