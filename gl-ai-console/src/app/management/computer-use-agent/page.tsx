...
import { ExternalLink, AlertCircle, RefreshCw, Monitor } from "lucide-react"
import { AppHelpModal, HelpButton } from "@/components/shared/app-help-modal"

const CUA_URL = "https://strms-cua-agent.vercel.app/"
...
export default function ComputerUseAgentPage() {
  ...
  const openInNewTab = () => {
    window.open(CUA_URL, "_blank", "noopener,noreferrer")
  }
    ...
    <div className="flex flex-col h-screen bg-[#FAF9F9]">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-white">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-[#407B9D]/10 flex items-center justify-center">
            <Monitor className="w-5 h-5 text-[#407B9D]" />
          </div>
          <div>
            <h1
      ...
      <div className="flex-1 relative">
            ...
            <Card className="max-w-md mx-4 bg-white border-none shadow-lg">
              <CardHeader className="text-center pb-2">
                ...
                <CardTitle
                  ...
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  Unable to Embed Computer Use Agent
                </CardTitle>
                <CardDescription
                  className="text-sm"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  Computer Use Agent may have security settings that prevent embedding. You can still access it in a new tab.
                </CardDescription>
              </CardHeader>
              <CardContent className="flex flex-col gap-3">
                ...
                >
                  ...
                  Open Computer Use Agent in New Tab
                </Button>
                <Button
                  variant="outline"
                  onClick={retryIframe}
        ...
        <iframe
          ...
          title="Computer Use Agent - AI-Powered Desktop Automation"
      ...
      {/* Help Modal */}
      <AppHelpModal
        appName="Computer Use Agent"
        appDescription="AI agent that automatically downloads and organizes bank statements from financial institutions. Streamlines the process of gathering financial documents for accounting workflows."
        isOpen={showHelp}
