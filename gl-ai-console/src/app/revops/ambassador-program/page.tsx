...
import { ExternalLink, AlertCircle, RefreshCw, Award } from "lucide-react"
import { AppHelpModal, HelpButton } from "@/components/shared/app-help-modal"

const AMBASSADOR_URL = "https://referral-dashboard-roan.vercel.app/"
...
export default function AmbassadorProgramPage() {
  ...
  const openInNewTab = () => {
    window.open(AMBASSADOR_URL, "_blank", "noopener,noreferrer")
  }
  ...
  const retryIframe = () => {
    ...
    if (iframeRef.current) {
      iframeRef.current.src = AMBASSADOR_URL
    }
  }
    ...
    <div className="flex flex-col h-screen bg-[#FAF9F9]">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-white">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-[#407B9D]/10 flex items-center justify-center">
            <Award className="w-5 h-5 text-[#407B9D]" />
          </div>
          <div>
            <h1
      ...
      <div className="flex-1 relative">
            ...
            <Card className="max-w-md mx-4 bg-white border-none shadow-lg">
              <CardHeader className="text-center pb-2">
                ...
                <CardTitle
                  ...
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  Unable to Embed Ambassador Program
                </CardTitle>
                <CardDescription
                  className="text-sm"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  The Ambassador Program may have security settings that prevent embedding. You can still access it in a new tab.
                </CardDescription>
              </CardHeader>
              <CardContent className="flex flex-col gap-3">
                ...
                >
                  ...
                  Open Ambassador Program in New Tab
                </Button>
                <Button
                  variant="outline"
                  onClick={retryIframe}
        ...
        <iframe
          ...
          title="Ambassador Program - Referral Dashboard"
      ...
      {/* Help Modal */}
      <AppHelpModal
        appName="Ambassador Program"
        appDescription="Manage referral partnerships and track ambassador performance with real-time analytics and reporting."
        isOpen={showHelp}
