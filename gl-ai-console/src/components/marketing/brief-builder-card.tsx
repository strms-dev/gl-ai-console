...
export function BriefBuilderCard({ briefsInProgressCount, onOpenModal, onCreateBrief }: BriefBuilderCardProps) {
  return (
    <Card className="bg-white border border-slate-100 shadow-sm hover:shadow-xl hover:border-[#95CBD7]/30 transition-all duration-300 hover:-translate-y-0.5 relative group">
      {/* Decorative gradient */}
