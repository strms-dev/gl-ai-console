...
import { ChatMessage, WorkflowContext } from "@/lib/marketing-content-types"
...
const contextLabels: Record<WorkflowContext, string> = {
  dashboard: 'Content Engine',
  topic_radar: 'Topic Radar',
  brief_builder: 'Brief Builder',
  repurpose: 'Repurpose Factory',
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Ask questions about your content strategy, get suggestions, or request analysis.
                </p>
